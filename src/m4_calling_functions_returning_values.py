...
def run_test_fancy_sums_of_digits():
    ...
    print('       actual:  ', answer)
    expect = 110610
    answer = fancy_sums_of_digits(27)
    print('Test 1 expected:', expect)
    print('       actual:  ', answer)
    expect = 132030
    answer = fancy_sums_of_digits(45)
    print('Test 1 expected:', expect)
    print('       actual:  ', answer)
    # -------------------------------------------------------------------------
