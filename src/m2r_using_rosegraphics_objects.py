...
#              Yicheng Yang,it's the left up corner of the window
#
#        -- In what direction on the screen
#           does the positive X-axis point?
#              Yicheng Yang,left to right
#
#        -- In what direction on the screen
#           does the positive Y-axis point?
#              Yicheng Yang,up to down
#
...
#            Yicheng Yang,window = rg.RoseWindow (width, 100)
#
...
#                Yicheng Yang,rg.RoundedRectangle,rg.RoseCanvas
#
#          -- Write the names of three METHODs that Circle objects have:
#               Yicheng Yang,circle.attach_to,circle.clone(),circle.get_bounding_box()
#
#          -- Write the names
#                Yicheng Yang,_REP of three INSTANCE VARIABLEs that Circle
# #             objects have:fill_color
#
#     f. What does a RoseWindow RENDER method do?
#            Yicheng Yang,Updates all the Shapes attached to RoseCanvas objects associated
...
#        necessary?  Why?
#            Yicheng Yang,if we don't have such method, a display that goes too fast would not be observed.
#
